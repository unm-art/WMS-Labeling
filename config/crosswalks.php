...
$shelf_loc = array(
  ...
  //      "Ask for Assistance at Service Desk" => "ZIM<br />Alice<br />Clark<br />Room",
        ...
        "Herzstein Room" => "ZIM<br />Herz-stein",
        "Indigenous Nations Library Program" => "ZIM<br />INLP",
        "International Collection" => "ZIM<br />Inter-national",
   ...
   //     "Reference" => "ZIM<br />Ref<br />Desk.",
    ...
    "IQUC" => array(
        ...
        "Manuscripts - H.S. - Library Use Only" => "ZIM<br />CSWR<br />Manu-scripts",
        "Manuscripts - Library Use Only" => "ZIM<br />CSWR<br />Manu-scripts",
    ...
    "IQUS" => array(
        ...
        "Government CD/DVD" => "CSEL<br />Gov<br />Pub<br />CD-Rom",
        "Government Publications" => "CSEL<br />Gov<br />Pub<br /><br />",
