...
function pageLoad(page, params) {
  if (!params) {
    ...
    .fail(function(data, status, jqXHR) {
      $("#main_content").html('<div class="errorMsg"><h2>Error</h2>We are having problems connecting to OCLC\'s servers. Please press the back button on your browser and try again.</div>');
    })
    .always(function() {
      $('#loadingScreen').hide();
    });
